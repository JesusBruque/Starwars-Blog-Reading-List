			...
			<div className="card-body mb-2">
				...
				<div className="d-flex justify-content-between">
					<button className="btn btn-outline-primary btn-outline-primary:hover btn-outline-primary:active btn-outline-primary:visited">
						<Link id="a" to={"/info/" + props.id}>Learn more!</Link>
					</button>
					<button /* onClick={actions.addFavourites(setFavourites)} */ className="btn btn-outline-warning btn-outline-warning:hover btn-outline-warning:active btn-outline-warning:visited"><svg id="heart" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-heart text-warning" viewBox="0 0 16 16">
